...
private slots:
    void solveProblem() {
        ...
        if (!okN || !okK || n <= 0 || k <= 0) {
            resultBox->clear();
            QMessageBox::warning(this, "Invalid Input", "Please enter valid positive integers for people and step size.");
            return;
        }

        int survivor = josephus(n, k);
        resultBox->setText(QString("With %1 people and step size %2,\nthe safe position is: %3")
...
#include "main.moc"
/*  Yoo its the code i hope this helps any one 
